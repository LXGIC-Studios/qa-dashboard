...
export default function BotsPage() {
  ...
  // webhook removed - bots just poll
      ...
      {showRegister && (
        <div className="bg-card border border-card-border rounded-xl p-4 md:p-6">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <p className="text-[10px] text-muted-foreground">Token auto-generated. Give the bot its poll endpoint URL so it can check for work.</p>
          </form>
        </div>
      )}
